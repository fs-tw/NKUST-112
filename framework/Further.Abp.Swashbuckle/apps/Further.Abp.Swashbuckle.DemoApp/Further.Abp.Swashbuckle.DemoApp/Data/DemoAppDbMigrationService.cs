...
namespace Further.Abp.Swashbuckle.DemoApp.Data;
...
public class DemoAppDbMigrationService : ITransientDependency
{
    ...
    private readonly DemoAppEFCoreDbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public DemoAppDbMigrationService(
        IDataSeeder dataSeeder,
        DemoAppEFCoreDbSchemaMigrator dbSchemaMigrator,
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "Further.Abp.Swashbuckle.DemoApp");
    }
