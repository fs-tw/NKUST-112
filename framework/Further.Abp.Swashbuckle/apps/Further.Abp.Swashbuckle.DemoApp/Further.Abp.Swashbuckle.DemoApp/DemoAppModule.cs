...
using Further.Abp.Swashbuckle.DemoApp.Data;
using Further.Abp.Swashbuckle.DemoApp.Localization;
using Further.Abp.Swashbuckle.DemoApp.Menus;
...
[DependsOn(typeof(Swashbuckle.AbpSwashbuckleModule))]
public class DemoAppModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "83bb674e-7d61-4262-bc2c-ad2256a334a7");
            });
        }
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(DemoAppModule).Assembly);
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<DemoAppModule>(/* validate: true */);
        });
    }
