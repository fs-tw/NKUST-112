...
using Further.Abp.LineNotify.DemoApp.Data;
using Further.Abp.LineNotify.DemoApp.Localization;
using Further.Abp.LineNotify.DemoApp.Menus;
...
public class DemoAppModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "a77ca280-f900-44a1-824d-9f1291c441cb");
            });
        }
    }
